...
const BACKEND_URL = "http://localhost:5000/api/openai/quiz";
...
export default function QuizCard() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      setQuiz(res.data.result || "No quiz questions returned from server.");
    } catch (err) {
      console.error("API Error:", err);
      setError("Failed to generate quiz. Backend might be down.");
      setQuiz("");
    } finally {
      setIsLoading(false);
    }
